...
const fullImages = [
    ...
    { src: "/fotos/expanded/34.png", label: "Casarão" },
    { src: "/fotos/expanded/35.png", label: "Recepção" },
    { src: "/fotos/expanded/36.png", label: "Salão de Festas" },
    { src: "/fotos/expanded/37.png", label: "Salão de Festas" },
    { src: "/fotos/expanded/38.png", label: "Salão de Festas" },
    { src: "/fotos/expanded/39.png", label: "Salão de Festas" },
    { src: "/fotos/expanded/40.png", label: "Churrasqueira" },
    { src: "/fotos/expanded/41.png", label: "Churrasqueira" },
    { src: "/fotos/expanded/42.png", label: "Lago Engenho" },
    { src: "/fotos/expanded/43.png", label: "Lago Engenho" },
