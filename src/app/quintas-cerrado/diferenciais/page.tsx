...
const DiferenciaisPage = () => {
    ...
    const imageMap: Record<string, string> = {
        sustentabilidade: "/diferenciais/sustentabilidade.png",
        seguranca: "/diferenciais/seguranca.png",
        infraestrutura: "/diferenciais/infraestrutura.png",
    }
    const imageSrc = imageMap[submenu ?? ""] || imageMap.sustentabilidade
    return (
