...
const casasRows: CasaItem[][] = [
  [
    { title: "Fachada", href: "/proj-casas/angico/1.png", index: 1 },
    { title: "Fachada", href: "/proj-casas/angico/2.png", index: 2 },
    { title: "Fireplace", href: "/proj-casas/angico/3.png", index: 3 },
],
[
      { title: "Área de Lazer", href: "/proj-casas/angico/4.png", index: 4 },
    { title: "Fachada", href: "/proj-casas/angico/5.png", index: 5 },
    { title: "Fachada", href: "/proj-casas/angico/6.png", index: 6 },
  ],
]
...
const expandedImages: ExpandedImage[] = [
  { src: "/proj-casas/angico/expanded/1.png", alt: "Fachada" },
  { src: "/proj-casas/angico/expanded/2.png", alt: "Fachada" },
  { src: "/proj-casas/angico/expanded/3.png", alt: "Fireplace" },
  { src: "/proj-casas/angico/expanded/4.png", alt: "Área de Lazer" },
  { src: "/proj-casas/angico/expanded/5.png", alt: "Fachada" },
  { src: "/proj-casas/angico/expanded/6.png", alt: "Fachada" },
]

const AngicoGrid: React.FC = () => {
