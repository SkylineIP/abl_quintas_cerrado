...
const casasRows: CasaItem[][] = [
    [
        { title: "Fachada", href: "/proj-casas/aroeira/videos/1.png", index: 1 },
        { title: "Fachada", href: "/proj-casas/aroeira/videos/2.png", index: 2 },
        { title: "Fireplace", href: "/proj-casas/aroeira/videos/3.png", index: 3 },
    ],
    [
        { title: "Área de Lazer", href: "/proj-casas/aroeira/videos/4.png", index: 4 },
        { title: "Fachada", href: "/proj-casas/aroeira/videos/5.png", index: 5 },
    ],
]
...
const AroeiraVideosGrid: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-full  py-8 gap-2 px-12 relative  animate-fade animate-duration-[2000ms]">
            ...
            <div className="w-full h-full flex flex-col items-center justify-center gap-4 mt-30">
                {casasRows.map((row, rowIndex) => (
                    ...
                    >
                        {row.map((item, index) => (
                            <div
                                key={index}
                                className="relative w-[48%] aspect-[6/5] rounded-2xl overflow-hidden hover:scale-[1.01] transition-transform duration-300"
...
export default AroeiraVideosGrid
