...
const casasRows: CasaItem[][] = [
  [
    { title: "Fachada", href: "/proj-casas/jatoba/1.png", index: 1 },
    { title: "Fachada", href: "/proj-casas/jatoba/2.png", index: 2 },
    { title: "Fireplace", href: "/proj-casas/jatoba/3.png", index: 3 },
],
[
      { title: "Área de Lazer", href: "/proj-casas/jatoba/4.png", index: 4 },
    { title: "Fachada", href: "/proj-casas/jatoba/5.png", index: 5 },
    { title: "Fachada", href: "/proj-casas/jatoba/6.png", index: 6 },
  ],
]
...
const expandedImages: ExpandedImage[] = [
  { src: "/proj-casas/jatoba/expanded/1.png", alt: "Fachada" },
  { src: "/proj-casas/jatoba/expanded/2.png", alt: "Fachada" },
  { src: "/proj-casas/jatoba/expanded/3.png", alt: "Fachada" },
  { src: "/proj-casas/jatoba/expanded/4.png", alt: "Garagem" },
  { src: "/proj-casas/jatoba/expanded/5.png", alt: "Fachada" },
  { src: "/proj-casas/jatoba/expanded/6.png", alt: "Área de Lazer" },
]

const JatobaGrid: React.FC = () => {
